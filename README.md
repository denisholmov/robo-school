...
|--ui/              # универсальные самые простые переиспользуемые компоненты. button/input/простые компоненты. Эти компоненты могут переиспользоваться в любом модуле/components, по любому пути/домену(/admin, /login, /home и тд)
```
